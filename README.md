...
### 🇧🇷 Português
Sou um desenvolvedor focado em construir soluções eficientes e apaixonado por dados. Tenho experiência sólida em **C** e **Python**, utilizando **Git e GitHub** para um controle de versão organizado e colaborativo.
...
### 🇺🇸 English
I am a developer focused on building efficient solutions and passionate about data. I have solid experience in **C** and **Python**, using **Git and GitHub** for organized and collaborative version control.
